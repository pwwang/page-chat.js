...
/**
 * Check if a dependency name is a page-chat internal package
 */
function isInternalPackage(name) {
	return name === 'page-chat' || name.startsWith('@page-chat/')
}
...
const CDN_DEMO_URL_OLD = `https://cdn.jsdelivr.net/npm/page-chat@${oldVersion}/dist/iife/page-chat.demo.js`
const CDN_DEMO_URL_NEW = `https://cdn.jsdelivr.net/npm/page-chat@${newVersion}/dist/iife/page-chat.demo.js`
const CDN_DEMO_CN_URL_OLD = `https://registry.npmmirror.com/page-chat/${oldVersion}/files/dist/iife/page-chat.demo.js`
const CDN_DEMO_CN_URL_NEW = `https://registry.npmmirror.com/page-chat/${newVersion}/files/dist/iife/page-chat.demo.js`
