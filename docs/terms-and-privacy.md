...
"We" in this document refers to the maintainers of the open-source Page Chat project (https://github.com/alibaba/page-chat). "The software" refers to Page Chat (the JavaScript library) and Page Chat Ext (the browser extension). This document covers the software itself and the testing API we provide — **not** any third-party product or service built with it.
...
The project is open source under the [MIT License](https://github.com/alibaba/page-chat/blob/main/LICENSE) and can be audited at: https://github.com/alibaba/page-chat
...
## 3. Browser Extension (Page Chat Ext)
...
https://github.com/alibaba/page-chat/issues
